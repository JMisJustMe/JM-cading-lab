...
requestAnimationFrame(()=>setTimeout(()=>setState("idle",(verbs[surface]||"CONTACT")+" READY · "+(names[surface]||surface.toUpperCase())),520));
let timer;
...
d.addEventListener("pointerdown",e=>{const t=e.target.closest?.("a,button,summary,[role='button']");if(t)contact(t)}, {passive:true});
