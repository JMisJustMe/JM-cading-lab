const CACHE='routebreak-v1.0.0-split-source';
const FILES=['./','./index.html','./src/styles.css','./src/game-core.js','./src/game-simulation.js','./src/game-render.js','./manifest.webmanifest'];
