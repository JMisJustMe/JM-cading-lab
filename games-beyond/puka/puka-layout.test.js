...
has(html,'puka-table-read-v02.css','v0.14 Human Game presentation layer must be mounted');
has(html,'puka-human-game-v02.js','v0.14 Human Game engine must be mounted');
...
has(sw,'puka-deep-house-v13.js','v0.13 Deep House organ not cached');
has(sw,'puka-deep-house-lattice-v13.svg','v0.13 Deep House lattice not cached');
has(sw,'puka-table-read-v02.css','v0.14 Human Game presentation layer not cached');
has(sw,'puka-human-game-v02.js','v0.14 Human Game engine not cached');
