...
has(html,'PUKA v0.7A','v0.7A front-door marker missing');
has(html,'puka-v07.css','v0.7 world styling not mounted');
has(html,'puka-world-v07.js','v0.7 world organ not mounted');
has(sw,"jm-puka-v07a",'service worker cache version not bumped');
has(sw,'puka-v07.css','v0.7 world style not cached');
has(sw,'puka-world-v07.js','v0.7 world organ not cached');
for(const asset of ['court-lower-v07.svg','court-middle-v07.svg','court-high-v07.svg','court-heir-v07.svg','court-throne-v07.svg']) has(sw,asset,`${asset} not cached`);
...
has(world,'@media(max-width:380px)','narrow-phone ascent guard missing');
has(world,'@media(prefers-reduced-motion:reduce)','court reduced-motion guard missing');
...
console.log('PUKA LAYOUT + ART + CHARACTER + WORLD SOURCE DING PASS');
