...
has(html,'puka-v13.css','v0.13 Deep House layer must be mounted');
has(html,'puka-deep-house-v13.js','v0.13 Deep House organ must be mounted');
...
has(sw,"jm-puka-v13a",'current service worker cache version not bumped');
