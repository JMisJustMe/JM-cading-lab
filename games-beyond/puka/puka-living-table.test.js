...
has(html,'puka-read-lab-v01.js','Declared Read Lab must remain mounted over inherited living table');
has(html,'puka-read-calibration-v01.js','Counterread calibration must remain mounted over inherited living table');
...
has(sw,'jm-puka-v16a','current cache marker missing');
for(const item of ['puka-v10.css','puka-v11.css','puka-v12.css','puka-v13.css','puka-table-read-v02.css','puka-human-game-v02.js','puka-read-lab-v01.js','puka-read-calibration-v01.js','puka-living-table-v10.js','puka-chip-column-v10.svg']) has(sw,item,`${item} not cached`);
...
console.log('PUKA v0.10A LIVING TABLE SOURCE DING PASS INSIDE CURRENT v0.16A DESCENDANT');