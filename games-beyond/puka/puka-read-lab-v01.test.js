...
assert(html.includes('PUKA v0.15A'),'OPEN_FIRST version not advanced');
assert(sw.includes("jm-puka-v15a")&&sw.includes('puka-read-lab-v01.js')&&sw.includes('puka-read-lab-v01.css'),'Offline carrier does not include v0.15A Read Lab');

console.log('PUKA v0.15A READ LAB CODE DING PASS');
